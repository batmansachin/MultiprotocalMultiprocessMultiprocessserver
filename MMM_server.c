...
int c;
// int a=mkfifo("/home/sachin/Documents/Message_App_server_client/server_both_tcp_udp.c",0666);
// if(a==-1)
...
// int b=open("/home/sachin/Documents/Message_App_server_client/server_both_tcp_udp.c",O_RDWR);
// read(b,mainbuf,100);
